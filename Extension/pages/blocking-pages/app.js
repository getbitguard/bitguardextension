...
module.exports = {"malware":"Webová stránka <strong>(var.Host)</strong> byla ohlášena jako škodlivá a na základě Vašich bezpečnostních nastavení byla zablokována.","phishing":"Webová stránka <strong>(var.Host)</strong> byla ohlášena jako podvodná a na základě Vašich bezpečnostních nastavení byla zablokována.","advancedButton":"Pokročilé","moreInfoButton":"Více informací","pageTitle":"Přístup odepřen","safeHeaderTitle":"BitGuard zablokoval přístup na tuto stránku","safeContentTitle":"Webová stránka byla ohlášena jako škodlivá a na základě Vašich bezpečnostních nastavení byla zablokována.","parentalHeaderTitle":"Rodičovská kontrola","parentalContentTitle":"Tuto stránku jsme zablokovali kvůli omezením rodičovského filtru.","parentalDescOne":"Máte na to věk? Zadejte heslo","parentalDnsDescTwo":"Pokoušíte navštívit stránku, kterou BitGuard eviduje jako nevhodnou pro děti. Pokud jste dospělý/á, můžete v nastavení vypnout rodičovskou kontrolu nebo tuto stránku přidat na seznam povolených.","blockedContentTitle":"Přístup na {site} byl zablokován pravidlem filtru. Chcete-li tuto stránku zobrazit, přidejte ji mezi výjimky.","ruleHeaderTitle":"Blokováno programem BitGuard","ruleContentTitle":"BitGuard zabránil načtení této stránky kvůli následujícímu pravidlu filtru","btnGoBack":"Zpět","btnFeedback":"Odeslat zpětnou vazbu","btnProceed":"Přesto pokračovat","btnProceedTo":"Pokračovat na stránku","inputPassword":"Zadejte heslo","errorPageHeader":"Webová stránka není dostupná","summary":"Webová stránka <strong>(var.PageUrl)</strong> může být dočasně nedostupná, nebo se přesunula na jinou adresu.","suggestionsHeader":"Zde jsou některé návrhy","suggestion1":"Zkuste <a href='(var.PageUrl)'>znovu načíst</a> tuto webovou stránku později.","suggestion2":"Zkontrolujte webovou adresu a ujistěte se, že jste ji zadali správně.","suggestion3":"Zkontrolujte nastavení brány firewall. Všechna připojení by měla být pro BitGuard povolena.","suggestion4":"Zkontrolujte nastavení serveru proxy, pokud jej používáte.","showDetails":"Zobrazit podrobnosti","wrongPassword":"Nesprávné heslo","somethingWrong":"Něco se pokazilo. Zkuste to znovu později nebo kontaktujte naši technickou podporu.","errorPageTitle":"Chyba"};
...
module.exports = {"malware":"این صفحه وب در <strong>(var.Host)</strong> بعنوان صفحه بدافزاز گزارش شده و بر طبق اولویت های امنیتی شما مسدود شده است.","phishing":"این صفحه وب در <strong>(var.Host)</strong> بعنوان صفحه فیشینگ گزارش شده و بر طبق اولویت های امنیتی شما مسدود شده است.","advancedButton":"پيشرفته","moreInfoButton":"اطلاعات بیشتر","pageTitle":"دسترسی رد شد","safeHeaderTitle":"BitGuard دسترسی به این صفحه را مسدود کرده است","safeContentTitle":"این صفحه وب بعنوان صفحه بدافزاز گزارش شده و بر طبق اولویت های امنیتی شما مسدود شده است.","parentalHeaderTitle":"نظارت والدین","parentalContentTitle":"ما این صفحه را به علت محدودیت فیاتر نظارت والدین مسدود کردیم.","parentalDescOne":"آیا به اندازه کافی سن تان زیاد است؟ رمزعبور را وارد کنید","parentalDnsDescTwo":"BitGuard دسترسی شما را بدلیل اینکه این محتوا مناسب کودکان نیست محدود کرده است. اگر شما یک انسان بالغ هستید میتوانید نظارت والدین را در قسمت تنظیمات غیرفعال کرده یا این سایت را در لیست سفید قرار دهید.","blockedContentTitle":"درخواست به {site} با مدل دستور فیلتر مسدود شده است. اگر میخواهید به این سایت دسترسی داشته باشید آن را به استثناء ها اضافه کنید.","ruleHeaderTitle":"با BitGuard مسدود شده است","ruleContentTitle":"BitGuard از دسترسی به این صفحه به علت دستور فیلتر زیر جلوگیری کرد","btnGoBack":"برگرد","btnFeedback":"اِرسال بازخورد","btnProceed":"بهر حال ادامه بده","btnProceedTo":"برو به سایت","inputPassword":"رمزعبور را وارد کنید","errorPageHeader":"صفحه وب در دسترس نیست","summary":"صفحه وب در<strong>(var.PageUrl)</strong> امکان دارد موقتی از کار افتاده باشد یا آ« به آدرس وب جدید تغیر مکان یافته باشد.","suggestionsHeader":"در اینجا تعدادی پیشنهاد","suggestion1":"در بعد سعی کنید این صفحه وب <a href='(var.PageUrl)'>بارگیری مجدد</a> کنید.","suggestion2":"آدرس وب را بررسی کنید و مطمئن شوید به درستی تایپ شده است.","suggestion3":"تنظیمات فایروال خود را چک کنید. BitGuard باید اجازه دسترسی به همه اتصالات را داشته باشد.","suggestion4":"اگر از پراکسی سرور استفاده می کنید،تنظیمات پراکسی را امتحان کنید.","showDetails":"نمایش جزئیات","wrongPassword":"رمزعبور اشتباه است","somethingWrong":"مشکلی وجود دارد.لطفا بعدا امتحان کنید یا با سرویس پشتیبانی تماس بگیرید","errorPageTitle":"خطا"};
...
module.exports = {"malware":"<strong>(var.Host)</strong> はマルウェアのページとして報告されています。セキュリティの設定に基づいてブロックされました。","phishing":"<strong>(var.Host)</strong> はフィッシング詐欺のページとして報告されており、セキュリティの設定に基づいてブロックれました。","advancedButton":"高度な設定","moreInfoButton":"詳細","pageTitle":"アクセス拒否","safeHeaderTitle":"BitGuardはこのページへのアクセスをブロックしました","safeContentTitle":"このページはマルウェアのページとして報告されています。セキュリティの設定に基づいてブロックされました。","parentalHeaderTitle":"ペアレンタルコントロール","parentalContentTitle":"このページはペアレンタルコントロールによってブロックされました。","parentalDescOne":"大人の方はパスワードを入力してください。","parentalDnsDescTwo":"子どもに不適切なウェブサイトとしてBitGuardに登録されているサイトにアクセスしようとしています。設定を行った保護者の方は設定からペアレンタルコントロールをオフにするか、このウェブサイトをホワイトリストに追加することができます。","blockedContentTitle":"{site}へのリクエストはフィルタルールによってブロックされました。サイトにアクセスしたい場合は例外に追加してください。","ruleHeaderTitle":"BitGuardによってブロックされました","ruleContentTitle":"BitGuardは以下のフィルタリング・ルールに従って、このページの読み込みを防止しました。","btnGoBack":"戻る","btnFeedback":"フィードバックを送る","btnProceed":"そのまま続行する","btnProceedTo":"サイトへ続行する","inputPassword":"パスワードを入力","errorPageHeader":"ウェブページは利用できません","summary":"<strong>(var.PageUrl)</strong> にあるウェブページが一時的にダウンしているか、新しいウェブアドレスに移動している可能性があります。","suggestionsHeader":"問題を解決するために、次の操作をお試しください","suggestion1":"後ほどこのウェブページを<a href='(var.PageUrl)'>リロード</a>してみてください。","suggestion2":"Webページのアドレスが正しく入力してあるかを確認してください。","suggestion3":"ファイアウォールの設定を確認してください。 BitGuard接続のすべてが許可されている必要があります。","suggestion4":"プロキシサーバーを使用している場合は、プロキシ設定を確認してください。","showDetails":"詳細を表示","wrongPassword":"パスワードが間違っています","somethingWrong":"原因不明の問題が起きました。 後でもう一度お試しいただくか、サポートサービスにご連絡ください。","errorPageTitle":"エラー"};
...
module.exports = {"malware":"이 웹 페이지 <strong>(var.Host)</strong>는 악성 페이지로 보고되어, 설정하신 보안 설정에 따라 차단되었습니다.","phishing":"이 웹 페이지 <strong>(var.Host)</strong>는 피싱 페이지로 보고되어, 설정하신 보안 설정에 따라 차단되었습니다.","advancedButton":"고급 설정","moreInfoButton":"추가 정보","pageTitle":"접근 거부됨","safeHeaderTitle":"BitGuard가 이 페이지 접근을 차단하였습니다.","safeContentTitle":"이 웹 페이지는 악성 페이지로 보고되어, 설정하신 보안 설정에 따라 차단되었습니다.","parentalHeaderTitle":"자녀 보호","parentalContentTitle":"이 페이지는 자녀 보호 필터 제한으로 차단되었습니다.","parentalDescOne":"자녀 보호 모드를 해제하려면 비밀번호를 입력하세요.","parentalDnsDescTwo":"지금 BitGuard에서 지정한 어린이들에게 부적절한 웹 사이트에 접속하려고 합니다. 성인인 경우 설정에서 자녀 보호를 해제하거나 이 웹 사이트를 화이트리스트에 추가할 수 있습니다.","blockedContentTitle":"{site} 페이지는 필터 규칙에 의해 차단 되었습니다. 이 사이트에 접근하고 싶다면 예외 항목에 추가 하세요.","ruleHeaderTitle":"BitGuard에 의해 차단됨","ruleContentTitle":"다음 필터 규칙으로 인해 BitGuard에서 이 페이지를 로드하지 못했습니다.","btnGoBack":"뒤로가기","btnFeedback":"피드백 전송","btnProceed":"그래도 계속하기","btnProceedTo":"사이트 접속하기","inputPassword":"비밀번호 입력","errorPageHeader":"웹페이지를 사용할 수 없습니다.","summary":"<strong>(var.PageUrl)</strong> 웹 페이지는 일시적으로 다운되었거나 다른 웹 주소로 변경되었을 수 있습니다.","suggestionsHeader":"여기에 몇가지 제안이 있습니다.","suggestion1":"잠시 후 이 웹 페이지를 <a href='(var.PageUrl)'>새로고침</a>하세요.","suggestion2":"웹 페이지 주소를 올바르게 입력했는지 확인하세요.","suggestion3":"방화벽 설정을 확인하세요. BitGuard의 모든 연결은 허용되어 있어야 합니다.","suggestion4":"프록시 서버를 사용 하시면 프록시 설정을 확인 하세요.","showDetails":"자세히 보기","wrongPassword":"비밀번호가 맞지 않습니다.","somethingWrong":"알 수 없는 오류가 발생했습니다. 다시 시도하거나 고객 지원에 문의해주세요.","errorPageTitle":"오류"};
...
module.exports = {"malware":"Šis tinklalapis, adresu <strong>(var.Host)</strong>, buvo pažymėtas kaip kenkėjiškų programų puslapis ir buvo užblokuotas atsižvelgiant į jūsų saugos nuostatas.","phishing":"Šis tinklalapis, adresu <strong>(var.Host)</strong>, buvo pažymėtas kaip sukčiavimo puslapis ir buvo užblokuotas atsižvelgiant į jūsų saugos nuostatas.","advancedButton":"Papildomai","moreInfoButton":"Daugiau informacijos","pageTitle":"Prieiga neleidžiama","safeHeaderTitle":"BitGuard užblokavo prieigą prie šio puslapio","safeContentTitle":"Šis tinklalapis buvo pažymėtas kaip kenkėjiškų programų puslapis ir buvo užblokuotas atsižvelgiant į jūsų saugos nuostatas.","parentalHeaderTitle":"Tėvų kontrolė","parentalContentTitle":"Užblokavome šį puslapį dėl tėvų kontrolės filtrų apribojimų.","parentalDescOne":"Ar esate suaugęs? Įveskite slaptažodį","parentalDnsDescTwo":"Bandote pasiekti svetainę, kurią BitGuard laiko kaip netinkamą vaikams. Jei esate suaugęs, nustatymuose galite išjungti tėvų kontrolę arba įtraukti šią svetainę į baltąjį sąrašą.","blockedContentTitle":"Užklausą į {site} buvo užblokuota filtravimo taisyklės. Jei norite pasiekti šią svetainę, pridėkite ją prie išimčių.","ruleHeaderTitle":"Užblokavo BitGuard","ruleContentTitle":"BitGuard neleido įkelti šio puslapio dėl šios filtravimo taisyklės","btnGoBack":"Grįžti","btnFeedback":"Grįžtamasis ryšys","btnProceed":"Tęsti vis tiek","btnProceedTo":"Pereiti į svetainę","inputPassword":"Įveskite slaptažodį","errorPageHeader":"Tinklalapis nepasiekiamas","summary":"Tinklalapis <strong>(var.PageUrl)</strong> laikinai nepasiekiamas arba neegzistuoja.","suggestionsHeader":"Štai keletas prielaidų","suggestion1":"Pabandykite<a href='(var.PageUrl)'>įkelti</a> šį tinklalapį vėliau.","suggestion2":"Patikrinkite svetainės adresą, kad įsitikintumėte, jog jį teisingai įvedėte.","suggestion3":"Patikrinkite užkardos nustatymus. Visos jungtys turi būti leidžiamos BitGuard.","suggestion4":"Patikrinkite savo proxy nustatymus, jei jūs naudojate proxy serverį.","showDetails":"Rodyti išsamią informaciją","wrongPassword":"Neteisingas slaptažodis","somethingWrong":"Kažkas negerai. Pabandykite dar kartą vėliau arba susisiekite su mūsų palaikymo tarnyba.","errorPageTitle":"Klaida"};
...
module.exports = {"malware":"Táto stránka bola na <strong>(var.Host)</strong> nahlásená ako stránka so škodlivým kódom a bola zablokovaná na základe Vašich bezpečnostných nastavení.","phishing":"Stránka <strong>(var.Host)</strong> bola nahlásená ako podvodná a bola zablokovaná na základe Vašich bezpečnostných nastavení.","advancedButton":"Pokročilé","moreInfoButton":"Viac informácií","pageTitle":"Prístup bol zamietnutý","safeHeaderTitle":"BitGuard zablokoval prístup k tejto stránke","safeContentTitle":"Táto stránka bola nahlásená ako stránka so škodlivým kódom a bola zablokovaná na základe Vašich bezpečnostných nastavení","parentalHeaderTitle":"Rodičovská kontrola","parentalContentTitle":"Túto stránku sme zablokovali kvôli obmedzeniam rodičovského filtra.","parentalDescOne":"Ste plnoletý? Zadajte heslo","parentalDnsDescTwo":"Pokúšate sa navštíviť stránku, ktorú BitGuard eviduje ako nevhodnú pre deti. Ak ste dospelý/á, môžete v nastaveniach vypnúť rodičovskú kontrolu alebo túto stránku pridať na bielu listinu.","blockedContentTitle":"Prístup na {site} bol zablokovaný filtračným pravidlom. Ak chcete túto stránku zobraziť, pridajte ju medzi výnimky.","ruleHeaderTitle":"Blokované BitGuardom","ruleContentTitle":"BitGuard zabránil načítaniu tejto stránky kvôli nasledujúcemu filtračnému pravidlu","btnGoBack":"Naspäť","btnFeedback":"Poslať spätnú väzbu","btnProceed":"Aj tak pokračovať","btnProceedTo":"Pokračovať na stránku","inputPassword":"Zadajte heslo","errorPageHeader":"Webová stránka nie je dostupná.","summary":"Stránka <strong>(var.PageUrl)</strong> môže byť dočasne nedostupná alebo sa presunula na novú adresu.","suggestionsHeader":"Tu sú niektoré návrhy","suggestion1":"Skúste stránku <a href='(var.PageUrl)'>znovu načítať </a> neskôr.","suggestion2":"Skontrolujte webovú adresu a uistite sa, že ste ju zadali správne.","suggestion3":"Skontrolujte Vaše nastavenia firewall. Všetky spojenia pre BitGuard musia byť povolené.","suggestion4":"Ak používate proxy server, skontrolujte nastavenia Vášho proxy.","showDetails":"Zobraziť podrobnosti","wrongPassword":"Neplatné heslo","somethingWrong":"Niečo sa pokazilo. Skúste to znova neskôr alebo kontaktujte našu službu podpory.","errorPageTitle":"Chyba"};
...
module.exports = {"malware":"Ta spletna stran v <strong>(var.Host)</strong> je bila prijavljena kot stran s slonamernimi programi in je bila onemogočena glede na vaše varnostne nastavitve.","phishing":"Ta spletna stran v <strong>(var.Host)</strong> je bila prijavljena kot lažna stran in je bila onemogočena glede na vaše varnostne nastavitve.","advancedButton":"Napredno","moreInfoButton":"Več informacij","pageTitle":"Dostop zavrnjen","safeHeaderTitle":"BitGuard je onemogočil dostop do te strani","safeContentTitle":"Ta spletna stran je bila prijavljena kot stran s slonamernimi programi in je bila onemogočena glede na vaše varnostne nastavitve.","parentalHeaderTitle":"Starševski nadzor","parentalContentTitle":"To stran smo onemogočili zaradi omejitev Starševskega filtra.","parentalDescOne":"Ste dovolj stari? Vnesite geslo","parentalDnsDescTwo":"Poskušate doseči spletno stran, ki ga je BitGuard navedel kot neprimerno za otroke. Če ste odrasli, lahko v nastavitvah izklopite Starševski nadzor ali dodate to spletno stran na seznam dovoljenih.","blockedContentTitle":"Zahteva za {site} je onemogočena s pravilom filtra. Če želite dostopati do te strani, jo dodajte izjemam.","ruleHeaderTitle":"Onemogočeno z BitGuardom","ruleContentTitle":"BitGuard je preprečil nalaganje te strani zaradi naslednjega pravila filtriranja","btnGoBack":"Pojdi nazaj","btnFeedback":"Pošlji povratne informacije","btnProceed":"Vseeno nadaljuj","btnProceedTo":"Pojdi na spletno stran","inputPassword":"Vnesite geslo","errorPageHeader":"Spletna stran ni na voljo","summary":"Spletna stran na <strong>(var.PageUrl)</strong>  je morda začasno onemogočena ali pa je morda prestavljena na nov spletni naslov.","suggestionsHeader":"Tukaj je nekaj predlogov","suggestion1":"Poskusite kasneje <a href='(var.PageUrl)'>ponovno naložiti</a> to spletno stran.","suggestion2":"Preverite naslov spletne strani in se prepričajte, da ste ga pravilno vnesli.","suggestion3":"Preverite svoje nastavitve požarnega zidu. Vse povezave je treba dovoliti za BitGuard.","suggestion4":"Preverite nastavitve Proxy strežnika, če ga uporabljate.","showDetails":"Prikaži podrobnosti","wrongPassword":"Napačno geslo","somethingWrong":"Nekaj je šlo narobe. Poskusite znova pozneje ali se obrnite na našo službo za podporo.","errorPageTitle":"Napaka"};
...
module.exports = {"malware":"<strong>(var.Host)</strong> adresindeki bu site kötü amaçlı yazılım sitesi olarak rapor edildi ve güvenlik tercihlerinize göre engellendi.","phishing":"<strong>(var.Host)</strong> adresindeki bu site kimlik avı sitesi olarak rapor edildi ve güvenlik tercihlerinize bağlı olarak engellendi.","advancedButton":"Gelişmiş","moreInfoButton":"Daha fazla bilgi","pageTitle":"Erişim engellendi","safeHeaderTitle":"BitGuard bu sayfaya erişimi engelledi","safeContentTitle":"Bu site kötü amaçlı yazılım içeren bir site olarak rapor edildi ve güvenlik tercihlerinize göre engellendi.","parentalHeaderTitle":"Ebeveyn kontrolü","parentalContentTitle":"Bu sayfayı ebeveyn filtresi kısıtlamaları nedeniyle engelledik.","parentalDescOne":"Yeterli yaşa sahip misin? Lütfen şifreyi girin","parentalDnsDescTwo":"BitGuard tarafından çocuklar için uygun olmayan bir web sitesine ulaşmaya çalışıyorsunuz. Yetişkin iseniz ayarlarda ebeveyn kontrolünü kapatabilir veya bu web sitesini beyaz listeye ekleyebilirsiniz.","blockedContentTitle":"{site} isteği, bir filtre kuralı tarafından engellendi. Bu siteye erişmek istiyorsanız, istisnalara ekleyin.","ruleHeaderTitle":"BitGuard tarafından engellendi","ruleContentTitle":"BitGuard, aşağıdaki filtre kuralı nedeniyle bu sayfanın yüklenmesini engelledi","btnGoBack":"Geri git","btnFeedback":"Geribildirim gönder","btnProceed":"Yine de devam et","btnProceedTo":"Siteye gir","inputPassword":"Parolayı girin","errorPageHeader":"Bu sayfa mevcut değil","summary":"Buradaki <strong>(var.PageUrl)</strong> websitesi geçici olarak devredışı olabilir ya da yeni bir web adresine taşınmış olabilir.","suggestionsHeader":"İşte birkaç öneri","suggestion1":"Bu web sayfasını daha sonra <a href='(var.PageUrl)'> yeniden yüklemeyi</a> deneyin.","suggestion2":"Web sayfasının adresini doğru girdiğinizden emin olun","suggestion3":"Güvenlik duvarı ayarlarınızı kontrol edin. BitGuard için tüm bağlantılara izin verilmelidir.","suggestion4":"Eğer bir proxy sunucusu kullanıyorsanız proxy ayarlarınızı kontol edin.","showDetails":"Detayları göster","wrongPassword":"Yanlış şifre girdiniz","somethingWrong":"Bir sorun oluştu. Lütfen daha sonra tekrar deneyiniz ya da destek servisimizle iletişime geçin.","errorPageTitle":"Hata"};
...
module.exports = {"malware":"Веб-сторінка <strong>(var.Host)</strong> відома, як зловмисна і була заблокована згідно з вашими налаштуваннями безпеки.","phishing":"Веб-сторінка <strong>(var.Host)</strong> відома, як шахрайська і була заблокована згідно з вашими налаштуваннями безпеки.","advancedButton":"Додатково","moreInfoButton":"Докладніша інформація","pageTitle":"Доступ заборонено","safeHeaderTitle":"BitGuard заблокував доступ до цієї сторінки","safeContentTitle":"Ця веб-сторінка відома, як зловмисна і була заблокована згідно з вашими налаштуваннями безпеки.","parentalHeaderTitle":"Батьківський контроль","parentalContentTitle":"Цю сторінку заблоковано у зв'язку з обмеженнями батьківського контролю.","parentalDescOne":"Якщо ви повнолітні, введіть пароль","parentalDnsDescTwo":"Ви намагаєтесь отримати доступ до веб-сайту, який в BitGuard позначений неприйнятним для дітей. Якщо ви повнолітні, ви можете вимкнути батьківський контроль в налаштуваннях, або додати цей веб-сайт до білого списку.","blockedContentTitle":"Запит до {site} було заблоковано правилом фільтру. Якщо ви хочете отримати доступ до цього сайту, додайте його до винятків.","ruleHeaderTitle":"Заблоковано BitGuard","ruleContentTitle":"BitGuard не дозволив цій сторінці завантажитись, у зв'язку з таким правилом фільтру","btnGoBack":"Назад","btnFeedback":"Надіслати відгук","btnProceed":"Продовжити в будь-якому разі","btnProceedTo":"Перейти на сайт","inputPassword":"Уведіть пароль","errorPageHeader":"Веб-сторінка недоступна","summary":"Веб-сторінка <strong>(var.PageUrl)</strong>, ймовірно, тимчасово недоступна, або її адреса змінилася.","suggestionsHeader":"Ось декілька пропозицій","suggestion1":"Спробуйте <a href='(var.PageUrl)'>перезавантажити</a> цю сторінку пізніше.","suggestion2":"Перевірте правильність введення адреси веб-сторінки.","suggestion3":"Перевірте налаштування мережевого екрану. Слід дозволити всі з'єднання для BitGuard.","suggestion4":"Перевірте ваші налаштування проксі-сервера, якщо ви його використовуєте.","showDetails":"Показати деталі","wrongPassword":"Хибний пароль","somethingWrong":"Щось пішло не так. Будь ласка, повторіть спробу пізніше або зверніться до нашої служби підтримки.","errorPageTitle":"Помилка"};
...
module.exports = {"malware":"位于 <strong>(var.Host)</strong> 的网页已报告为恶意网站，根据您的安全设置，我们拦截了与此网站的连接。","phishing":"位于 <strong>(var.Host)</strong> 的网页已报告为钓鱼网站，根据您的安全设置，我们拦截了与此网站的连接。","advancedButton":"高级设置","moreInfoButton":"更多信息","pageTitle":"拒绝访问","safeHeaderTitle":"BitGuard 已阻止访问此网页","safeContentTitle":"位于 <strong>(var.Host)</strong> 的网页已报告为恶意网站，根据您的安全设置，我们拦截了与此网站的连接。","parentalHeaderTitle":"家长控制","parentalContentTitle":"由于家长控制过滤器的限制，我们拦截了此网站。","parentalDescOne":"您的年龄是否满足使用要求？请输入密码","parentalDnsDescTwo":"您正在尝试访问在 BitGuard 家长控制中被列为不适合儿童访问的网站。如果你是成年人，你可以在 BitGuard 设置中关闭家长控制模块，或将此站点移至白名单中。","blockedContentTitle":"过滤规则已拦截了访问 {site}的请求。如果您要访问此网站，请将其添加到排除列表。","ruleHeaderTitle":"被 BitGuard 拦截","ruleContentTitle":"根据以下过滤规则， Adguard 已停止加载该网页。","btnGoBack":"返回","btnFeedback":"发送反馈","btnProceed":"依然继续访问","btnProceedTo":"前往该网站","inputPassword":"输入密码","errorPageHeader":"该网页当前不可用","summary":"该网页的 <strong>(var.PageUrl)</strong> 可能被临时关闭，或已永久移动到其它地址。","suggestionsHeader":"以下是我们提供的建议：","suggestion1":"您可以稍后再 <a href='(var.PageUrl)'> 重新加载</a> 此网页。","suggestion2":"请确保您输入的网页地址是正确的。","suggestion3":"请检查防火墙设置，有关 BitGuard 的全部连接都应当被允许。","suggestion4":"如果您正在使用代理服务，请检查相关的代理配置。","showDetails":"显示详细信息","wrongPassword":"密码错误","somethingWrong":"出现了一些问题。请稍后重试或者联系我们的客服支持。","errorPageTitle":"错误"};
...
module.exports = {"malware":"於 <strong>(var.Host)</strong> 之網頁已被報告為惡意軟體頁面，且根據您的安全性偏好設定，已被封鎖。","phishing":"於 <strong>(var.Host)</strong> 之網頁已被報告為網路釣魚頁面，且根據您的安全性偏好設定，已被封鎖。","advancedButton":"進階的","moreInfoButton":"更多的資訊","pageTitle":"拒絕存取","safeHeaderTitle":"BitGuard 已封鎖至該頁面之存取","safeContentTitle":"該網頁已被報告為惡意軟體頁面，且根據您的安全性偏好設定，已被封鎖。","parentalHeaderTitle":"家長監控","parentalContentTitle":"由於父母的過濾器限制，我們已封鎖該頁面。","parentalDescOne":"您夠大了嗎？輸入該密碼","parentalDnsDescTwo":"您正在嘗試觸及被 BitGuard 列為對孩子不合適的網站。如果您是成年人，那麼您可在設定中關掉家長監控或增加該網站至白名單。","blockedContentTitle":"至 {site} 之請求已被過濾器規則封鎖。如果您想要存取該網站，增加它至例外。","ruleHeaderTitle":"被 BitGuard 封鎖","ruleContentTitle":"由於下面的過濾器規則，BitGuard 已防止該頁面載入","btnGoBack":"返回","btnFeedback":"傳送回饋意見","btnProceed":"無論如何繼續","btnProceedTo":"前往網站","inputPassword":"輸入密碼","errorPageHeader":"該網頁為不可用的","summary":"於 <strong>(var.PageUrl)</strong> 之網頁可能暫時地下線，或它可能已移至新的網路位址。","suggestionsHeader":"這是一些建議","suggestion1":"稍後嘗試<a href='(var.PageUrl)'>重新載入</a>該網頁。","suggestion2":"檢查該網頁網址以確定您已正確地輸入它。","suggestion3":"檢查您的防火牆設定。所有的連線應被允許用於 BitGuard。","suggestion4":"如果您使用代理伺服器，檢查您的代理設定。","showDetails":"顯示細節","wrongPassword":"錯誤的密碼","somethingWrong":"某事物出現問題。請稍後再試，或與我們的支援服務聯繫。","errorPageTitle":"錯誤"};
